...
disparity_q_caution_race %>% 
  ...
  #mutate(q_minus_miu2 = q - miu_q2) %>%
  ggplot(aes(x = Year, y = q_minus_miu, color = variable))+
  geom_line()+
  facet_wrap(~SSP)
...
disparity_q_caution_race %>%
  pivot_longer(cols = q_white_caution:q_otherrace_caution, names_to = "variable", values_to = "q")  %>%
  mutate(q_minus_miu = q - miu_q) %>%
  mutate(variable = replace(variable, variable == "q_black_caution", "Non-Hispanic Black"),
         variable = replace(variable, variable == "q_white_caution", "Non-Hispanic White"),
         variable = replace(variable, variable == "q_hispanic_caution", "Hispanic (all races)"),
         variable = replace(variable, variable == "q_otherrace_caution", "Non-Hispanic other races")) %>%
  #pivot_longer(cols = white_to_total:otherrace_to_total, names_to = "variable", values_to = "value") %>%
  ggplot(aes(x = Year, y = q_minus_miu*100, group = variable, fill = variable))+
  ...
  theme(panel.spacing = unit(0.8, "lines"),
        ...
        legend.title = element_text(size = 11),
        legend.position = "bottom") +
  guides(fill= guide_legend(title="Race/Ethnicity", ncol = 2))+
  facet_wrap(~SSP, ncol = 4) +
  xlab("Year") +
  ylab("Absolute disparity")-> absolute_disparity_race_caution

absolute_disparity_race_caution
...
disparity_q_caution_race %>%
  ...
  ggplot()+
  geom_line(aes(x = Year, y = CoV, color = SSP)) +
  ...
  scale_y_continuous(breaks = c(seq(0, 0.3, by = 0.1)), limits = c(0, 0.3), expand = c(0, 0)) -> relative_disparity_all_caution
relative_disparity_all_caution
...
disparity_q_caution_race %>%
  ...
  dplyr::select(Year, SSP, Black, White, Hispanic, Others, miu_q) %>%
  pivot_longer(cols = Black:Others, names_to = "race", values_to = "q_ratio") %>%
  ggplot(aes(x = Year, y = q_ratio-1, fill = race))+
  geom_bar(position="dodge", stat="identity") +
  facet_wrap(~SSP) +
  scale_fill_brewer(palette = "Set1")+
  theme_bw()+
  ...
  facet_wrap(~SSP, ncol = 4) +
  xlab("Year") +
  ylab("Relative disparity") -> relative_disparity_race_caution

relative_disparity_race_caution

disparity_race_caution <- ggarrange(absolute_disparity_race_caution, relative_disparity_race_caution,
                                    nrow = 2, 
                                    common.legend = T,
                                    legend = "bottom")
disparity_race_caution

#ggsave("/Users/songkaihui/Documents/ResearchUNC/Heat/Figures/disparity_race_caution.png", width = 8, height = 6)


#### combine  -----

fig3_caution <- ggarrange(map_race_caution_2020, disparity_race_caution,
                          labels = c("A", "B"),
                          nrow = 2,
                          heights = c(1,1.5))
fig3_caution

ggsave("/Users/songkaihui/Documents/ResearchUNC/Heat/Figures/Fig3_caution.png", width = 9, height = 9)
...
map_race_per_data  %>%
  ...
  mutate(var = case_when(var == "rank_white" ~ "Non-Hispanic White",
                         ...
                         var == "rank_hispanic" ~ "Hispanic (all races)",
                         var == "rank_otherrace" ~ "Non-Hispanic other Races")) %>%
  filter(var %in% c("Non-Hispanic White", "Non-Hispanic Black", "Hispanic (all races)")) %>%
  ggplot() + 
  geom_sf(aes(fill = value*100, group = var), color = NA)+
  geom_sf(data = state_boundary, fill = NA, color = "grey40") +
  scale_fill_viridis(direction = -1, discrete = F,
  ...
  theme(panel.spacing = unit(0.8, "lines"),
        ...
        legend.position = "bottom",
        plot.subtitle = element_text(size = 10, face = "bold"))+  
  labs(fill = "Population percentile",
       subtitle = "2020") -> fig3a_2020
...
map_race_per_data  %>%
  ...
  theme(panel.spacing = unit(0.8, "lines"),
        ...
        plot.subtitle = element_text(size = 10, face = "bold")) +
  labs(fill = "Population percentile",
       subtitle = "2100") -> fig3a_2100
fig3a_2100

fig3a <- ggarrange(fig3a_2020, fig3a_2100,
                   nrow = 2,
                   common.legend = T,
                   legend = "bottom")
...
disparity_q_extreme_caution_race %>% 
  pivot_longer(cols = q_white_extreme_caution:q_otherrace_extreme_caution, names_to = "variable", values_to = "q")  %>%
  mutate(q_minus_miu = q - miu_q) %>%
  #mutate(q_minus_miu2 = q - miu_q2) %>%
  mutate(variable = replace(variable, variable == "q_black_extreme_caution", "Non-Hispanic Black"),
         variable = replace(variable, variable == "q_white_extreme_caution", "Non-Hispanic White"),
         variable = replace(variable, variable == "q_hispanic_extreme_caution", "Hispanic (all races)"),
         variable = replace(variable, variable == "q_otherrace_extreme_caution", "Non-Hispanic other races")) %>%
  ggplot(aes(x = Year, y = q_minus_miu, color = variable))+
  geom_line()+
  theme_bw()+
...
disparity_q_extreme_caution_race %>%
  ...
  facet_wrap(~SSP, ncol = 4) +
  xlab("Year") +
  ylab("Absolute disparity") ->absolute_disparity_race_extreme_caution 
absolute_disparity_race_extreme_caution 
...
disparity_q_extreme_caution_race %>%
  ...
  theme(plot.margin = margin(0.1,0.1,0.1,0.1, "cm"),
        ...
        legend.position = "right",
        plot.subtitle = element_text(size = 10, face = "bold")) +
  scale_y_continuous(breaks = c(seq(0, 0.5, by = 0.1)), limits = c(0, 0.5), expand = c(0, 0)) -> relative_disparity_all_extreme_caution
relative_disparity_all_extreme_caution

ggsave("/Users/songkaihui/Documents/ResearchUNC/Heat/Figures/CoV_extreme_caution.png", width = 6, height = 4)


disparity_q_extreme_caution_race %>%
  mutate(Black = q_black_extreme_caution/miu_q,
         White = q_white_extreme_caution/miu_q,
         Hispanic = q_hispanic_extreme_caution/miu_q,
         Others = q_otherrace_extreme_caution/miu_q) %>%
  dplyr::select(Year, SSP, Black, White, Hispanic, Others, miu_q) %>%
  pivot_longer(cols = Black:Others, names_to = "race", values_to = "q_ratio") %>%
  ggplot(aes(x = Year, y = q_ratio-1, fill = race))+
  geom_bar(position="dodge", stat="identity") +
  ...
  facet_wrap(~SSP, ncol = 4) +
  xlab("Year") +
  ylab("Relative disparity") -> relative_disparity_race_extreme_caution

relative_disparity_race_extreme_caution

disparity_race_extreme_caution <- ggarrange(absolute_disparity_race_extreme_caution, relative_disparity_race_extreme_caution,
                                            nrow = 2,
                                            common.legend = T,
                                            legend = "bottom")
disparity_race_extreme_caution


##### combine (Fig 3) -----

fig3_extreme_caution_race <- ggarrange(fig3a, disparity_race_extreme_caution,
                          labels = c("A", "B"),
                          nrow = 2,
                          heights = c(1.2,1)) +
  theme(plot.margin = margin(0.1,0.1,0.1,0.1, "cm")) 

fig3_extreme_caution_race

ggsave("/Users/songkaihui/Documents/ResearchUNC/Heat/Figures/Fig3_extreme_caution_race.png", width = 9, height = 10)
...
disparity_q_caution_age %>%
  pivot_longer(cols = q_young_caution:q_elderly_caution, names_to = "variable", values_to = "q")  %>%
  mutate(q_minus_miu = q - miu_q) %>%
  mutate(variable = replace(variable, variable == "q_young_caution", "Young"),
         variable = replace(variable, variable == "q_adult_caution", "Adult"),
         variable = replace(variable, variable == "q_elderly_caution", "Elderly")) %>%
  #pivot_longer(cols = white_to_total:otherrace_to_total, names_to = "variable", values_to = "value") %>%
  ggplot(aes(x = Year, y = q_minus_miu*100, group = variable, fill = variable))+
  geom_bar(position="dodge", stat="identity") +
  scale_fill_brewer(palette = "Set1")+
  ...
  facet_wrap(~SSP, ncol = 4) +
  xlab("Year") +
  ylab("Absolute disparity")-> absolute_disparity_age_caution

absolute_disparity_age_caution
...
disparity_q_caution_age %>%
  ...
  geom_line(aes(x = Year, y = CoV, color = SSP)) +
  theme_bw() + 
  scale_y_continuous(breaks = c(seq(0, 0.05, by = 0.01)), limits = c(0, 0.05), expand = c(0, 0)) -> relative_disparity_all_caution_age
relative_disparity_all_caution_age

disparity_q_caution_age %>%
  mutate(Young = q_young_caution/miu_q,
         Adult = q_adult_caution/miu_q,
         Elderly = q_elderly_caution/miu_q) %>%
  dplyr::select(Year, SSP, Young, Adult, Elderly,  miu_q) %>%
  pivot_longer(cols = Young:Elderly, names_to = "age", values_to = "q_ratio") %>%
  ggplot(aes(x = Year, y = q_ratio-1, fill = age))+
  geom_bar(position="dodge", stat="identity") +
  facet_wrap(~SSP) +
  scale_fill_brewer(palette = "Set1")+
  theme_bw()+
  ...
  facet_wrap(~SSP, ncol = 4) +
  xlab("Year") +
  ylab("Relative disparity") -> relative_disparity_age_caution

relative_disparity_age_caution

disparity_age_caution <- ggarrange(absolute_disparity_age_caution, relative_disparity_age_caution,
                                    nrow = 2, 
                                    common.legend = T,
                                    legend = "bottom")
disparity_age_caution

#ggsave("/Users/songkaihui/Documents/ResearchUNC/Heat/Figures/disparity_age_caution.png", width = 8, height = 6)
...
map_age_per_data  %>%
  ...
  mutate(var = case_when(var == "rank_young" ~ "Young",
                         var == "rank_adult" ~ "Adult",
                         var == "rank_elderly" ~ "Elderly")) %>%
  #var == "Young" ~ "Young (below age 19)",
  #var == "Elderly" ~ "Elderly (age 65+)")) %>%
  #filter(var!="Non-Hispanic other Races") %>%
  ggplot() + 
  geom_sf(aes(fill = value*100, group = var), color = NA)+
  geom_sf(data = state_boundary, fill = NA, color = "grey40") +
...
map_age_per_data  %>%
  ...
  pivot_longer(cols = c("rank_young", "rank_adult", "rank_elderly"), names_to = "var", values_to = "value") %>%
  filter(var %in% c("rank_young", "rank_adult", "rank_elderly")) %>% 
  mutate(var = case_when(var == "rank_young" ~ "Young (<20 y/o)",
                         var == "rank_adult" ~ "Adult (20-64 y/o)",
                         var == "rank_elderly" ~ "Elderly (65+ y/o)")) %>%
  ggplot() + 
  geom_sf(aes(fill = value*100, group = var), color = NA)+
  geom_sf(data = state_boundary, fill = NA, color = "grey40") +
  scale_fill_viridis(direction = -1, discrete = F,
...
map_age_per_data  %>%
  ...
  theme(plot.margin = margin(0,0,0,0, "cm"),
        ...
        plot.subtitle = element_text(size = 10, face = "bold")) +
  labs(fill = "Population percentile",
       subtitle = "2100") -> fig5a_2100
fig5a_2100

fig5a <- ggarrange(fig5a_2020, fig5a_2100,
                   nrow = 2,
                   common.legend = T,
                   legend = "bottom")
...
disparity_q_extreme_caution_age %>% 
  pivot_longer(cols = q_young_extreme_caution:q_elderly_extreme_caution, names_to = "variable", values_to = "q")  %>%
  mutate(q_minus_miu = q - miu_q) %>%
  ggplot(aes(x = Year, y = q_minus_miu, color = variable))+
  geom_line()+
  facet_wrap(~SSP)
...
disparity_q_extreme_caution_age %>%
  pivot_longer(cols = q_young_extreme_caution:q_elderly_extreme_caution, names_to = "variable", values_to = "q")  %>%
  mutate(q_minus_miu = q - miu_q) %>%
  mutate(variable = replace(variable, variable == "q_young_extreme_caution", "Young (<20 y/o)"),
         variable = replace(variable, variable == "q_adult_extreme_caution", "Adult (20-64 y/o)"),
         variable = replace(variable, variable == "q_elderly_extreme_caution", "Elderly (65+ y/o)")) %>%
  #pivot_longer(cols = white_to_total:otherrace_to_total, names_to = "variable", values_to = "value") %>%
  ggplot(aes(x = Year, y = q_minus_miu*100, group = variable, fill = variable))+
  geom_bar(position="dodge", stat="identity") +
  scale_fill_brewer(palette = "Set1")+
  ...
  facet_wrap(~SSP, ncol = 4) +
  xlab("Year") +
  ylab("Absolute disparity")-> absolute_disparity_age_extreme_caution

absolute_disparity_age_extreme_caution
...
disparity_q_extreme_caution_age %>%
  ...
  theme(panel.spacing = unit(0.8, "lines"),
        ...
        legend.title = element_text(size = 10),
        legend.position = "bottom") +
  scale_y_continuous(breaks = c(seq(0, 0.5, by = 0.1)), limits = c(0, 0.5), expand = c(0, 0)) -> relative_disparity_all_extreme_caution_age
relative_disparity_all_extreme_caution_age

disparity_q_extreme_caution_age %>%
  mutate(Young = q_young_extreme_caution/miu_q,
         Adult = q_adult_extreme_caution/miu_q,
         Elderly = q_elderly_extreme_caution/miu_q) %>%
  dplyr::select(Year, SSP, Young, Adult, Elderly, miu_q) %>%
  pivot_longer(cols = Young:Elderly, names_to = "Age", values_to = "q_ratio") %>%
  mutate(Age = replace(Age, Age == "q_young_extreme_caution", "Young (<20 y/o)"),
         Age = replace(Age, Age == "q_adult_extreme_caution", "Adult (20-64 y/o)"),
         Age = replace(Age, Age == "q_elderly_extreme_caution", "Elderly (65+ y/o)")) %>%
  ggplot(aes(x = Year, y = q_ratio-1, fill = Age))+
  geom_bar(position="dodge", stat="identity") +
  facet_wrap(~SSP) +
  scale_fill_brewer(palette = "Set1")+
  ...
  facet_wrap(~SSP, ncol = 4) +
  xlab("Year") +
  ylab("Relative disparity") -> relative_disparity_age_extreme_caution

relative_disparity_age_extreme_caution

disparity_age_extreme_caution <- ggarrange(absolute_disparity_age_extreme_caution, relative_disparity_age_extreme_caution,
                                            nrow = 2,
                                            common.legend = T,
                                            legend = "bottom")
disparity_age_extreme_caution


#### combine (Fig 5) -----

fig5_extreme_caution_age <- ggarrange(fig5a, disparity_age_extreme_caution,
                                      labels = c("A", "B"),
                                      nrow = 2,
                                      heights = c(1.2,1))
fig5_extreme_caution_age

ggsave("/Users/songkaihui/Documents/ResearchUNC/Heat/Figures/Fig5_extreme_caution_age.png", width = 9, height = 10)
